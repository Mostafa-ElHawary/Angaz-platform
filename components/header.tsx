...
export default function Header() {
  ...
  return (
    <header className="z-[999] relative ">
      <motion.div
        className="fixed top-0 left-1/2 h-[4.5rem] w-full rounded-none bg-white bg-opacity-40 shadow-lg shadow-black/[0.03] backdrop-blur-[0.2rem]  sm:h-[3.25rem]  dark:bg-gray-950 dark:border-black/40 dark:bg-opacity-75 "
